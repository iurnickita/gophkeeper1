...
import (
	...
	crypterConfig "github.com/iurnickita/gophkeeper1/server/internal/crypto/aesgcm/config"
	grpcServerConig "github.com/iurnickita/gophkeeper1/server/internal/grpc_server/server/config"
	loggerConfig "github.com/iurnickita/gophkeeper1/server/internal/logger/config"
	serviceConfig "github.com/iurnickita/gophkeeper1/server/internal/service/config"
	storeConfig "github.com/iurnickita/gophkeeper1/server/internal/store/config"
)
